...
//==========
VlUnpacked<CData/*5:0*/, 256> Vjpeg_core_jpeg_output_cx_ram::__Vtable1___PVT__cx_rd_ptr_r;
VlUnpacked<CData/*5:0*/, 256> Vjpeg_core_jpeg_output_cx_ram::__Vtable2___PVT__cx_rd_ptr_r;

Vjpeg_core_jpeg_output_cx_ram::Vjpeg_core_jpeg_output_cx_ram(const char* _vcname__)
