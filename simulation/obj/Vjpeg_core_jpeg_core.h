...
VL_MODULE(Vjpeg_core_jpeg_core) {
  ...
  public:
    ...
    static void _sequent__TOP__jpeg_core__3__deep18(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _sequent__TOP__jpeg_core__3__deep22(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _sequent__TOP__jpeg_core__3__deep26(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _sequent__TOP__jpeg_core__3__deep30(Vjpeg_core__Syms* __restrict vlSymsp);
    ...
    static void _settle__TOP__jpeg_core__1__deep1(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep10(Vjpeg_core__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__jpeg_core__1__deep10__deep11(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep10__deep12(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep13(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep14(Vjpeg_core__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__jpeg_core__1__deep14__deep15(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep14__deep16(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep2(Vjpeg_core__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__jpeg_core__1__deep2__deep4(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep5(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep6(Vjpeg_core__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__jpeg_core__1__deep6__deep8(Vjpeg_core__Syms* __restrict vlSymsp);
    static void _settle__TOP__jpeg_core__1__deep9(Vjpeg_core__Syms* __restrict vlSymsp);
  private:
